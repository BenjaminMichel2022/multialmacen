...
namespace pruebasAlmacen
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string almacenPrimario = "Almacen D";
            ...
            restart1:
                foreach (var element in list)
                {
                    ...
                    if (list.Count > 1 || almacenFinal.Equals(element.Almacen))
                    {
                        ...
                        if (almacenInicial.Almacen.Equals(element.Almacen) && !almacenPrimario.Equals(element.Almacen) && banderaSecundaria && almacenSecundario.Contains(element.Almacen) && banderaUsadoSecundario)
                        {
                            envios.Add(new ProductoEnvio
                            {
                                Almacen = element.Almacen,
                        ...
                        foreach (var element in list)
                        {
                            if (producto.Descripcion.Equals(element.Producto))
                            {
                                ...
                                if (element.Almacen.Equals(almacenPrimario) && almacenP)
                                {
                                    ...
                                    /////////////////////////////////////////////////////////////
                                    if (almacenFinal != "" || !((suma - element.Cantidad) >= producto.Cantidad) || (list.IndexOf(element) == 0))
                                    {
                                        almacenFinal = element.Almacen;
